...
var BaseSharedModule = (function () {
    function BaseSharedModule() {
    }
    return BaseSharedModule;
}());
BaseSharedModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.BaseSharedModule = BaseSharedModule;
//# sourceMappingURL=base.shared.module.js.map